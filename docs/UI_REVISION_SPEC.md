...
| Уровни осей (3/2/5 ур.; `rotor_rpm` 400/900) | ❌ нет | ❌ | ключа `levels`/номинальных осей нет ни в phr-спеке, ни в процесс-блоке |
...
| P2.1 | — | Дискретные уровни осей: сначала ядро (номинальная ось `rotor_rpm` 400/900, сетка уровней), потом UI |
