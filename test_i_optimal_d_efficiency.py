"""
Test D-efficiency preservation for I-optimal designs
"""

import numpy as np
from mixture_designs import MixtureDesign

print('I-OPTIMAL D-EFFICIENCY PRESERVATION TEST')
print('=====================================\n')
...
# Test with 30 runs
n_runs = 30
print(f'Generating I-optimal design with {n_runs} runs (linear model)...')
design = mixture.generate_i_optimal_mixture(n_runs=n_runs, model_type='linear', random_seed=42)
...
print(f"I-efficiency from evaluate_mixture_design: {results['i_efficiency']:.6f}")
print(f"This should match the optimization space D-efficiency value printed during generation.")
