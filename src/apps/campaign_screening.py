...
После измеренного стартового дизайна (seed) ядро кампании обучает GP-суррогаты
(:class:`GPExpert`, канон §5/§12), но пользователю нужна БЫСТРАЯ интерпретируемая сводка
...
GP-суррогатами. Слой ЧИСТЫЙ (без Streamlit): все функции тестируются напрямую
