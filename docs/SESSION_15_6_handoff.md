# Handoff / промт для новой сессии — §15.6 (экономический стоп), ШАГИ 6–7

Это вводная для сессии, которая **продолжит** реализацию §15.6. Шаги 1–5 сделаны,
зелёные, запушены в `main`. Осталось: **ШАГ 6 (A0.7, flat-ось)** и **ШАГ 7 (UI)**.
